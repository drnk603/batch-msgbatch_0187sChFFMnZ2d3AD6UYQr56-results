...
Этот JavaScript-файл обеспечивает:

✅ **Валидацию форм** с экранированными регулярными выражениями
✅ **Бургер-меню** с анимацией и высотой `calc(100vh - var(--header-h))`
✅ **Плавный скролл** и scroll-spy
✅ **Intersection Observer** для анимаций
✅ **Ripple эффекты** на кнопках
✅ **Count-up анимации** для цифр
✅ **Ленивая загрузка** через атрибут `loading="lazy"`
✅ **Scroll-to-top** кнопка
✅ **SOLID принципы** через классы
